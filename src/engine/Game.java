...
public class Game {
	...
	public void endTurn(){
		...
		}while (((Champion)turnOrder.peekMin()).getCondition().equals(Condition.INACTIVE));              //checks whether the current champion is inactive to remove it until it reaches an active champion
		turnsPassed++;
